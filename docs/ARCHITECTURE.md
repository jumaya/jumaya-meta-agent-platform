...
|-------|------|---------------|
| Architect | 8001 | Architecture design via lean interview |
| Coder | 8003 | Production-ready code generation |
| Tester | 8004 | Test suite generation |
| DevOps | 8005 | CI/CD and infrastructure as code |
| Security | 8007 | OWASP security reviews |

All agents use the model specified by the `MODEL` environment variable, accessed via the GitHub Models API.
